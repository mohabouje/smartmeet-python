...
class Element(ABC):
    ...
    * Source Elements generate data for use by a pipeline. Source elements do not accept data, they only generate data.

    * Filter Elements have both input and outputs pads. They operate on data that they receive on their input (sink) pads, and will provide data on their output (io) pads.
